...
/* ────────────────────────── 25 手工关卡 ────────────────────────── */
/* 难度曲线：L1-2 单镜入门 → L3-9 双镜 + 墙 → L10-13 三/四镜 → L14 起双发射器 → L19-20 收官 → L21-25 挑战档（par 5-6，BFS 复核无捷径）。 */
...
const LEVEL_SPECS = [
    ...
    // L6 双半路合璧（修任一面亮数不变——两面必须同时正确）
    { e: [[4, 0, '>']], m: [[4, 5, '/'], [1, 5, '\\']], k: [[4, 2], [2, 5], [1, 3], [1, 1]], w: [], flip: [[4, 5], [1, 5]] },
    // L7 唯一关键镜（末段镜单修无反馈，光路变形是唯一线索）
    { e: [[0, 2, 'v']], m: [[4, 2, '\\'], [4, 6, '/']], k: [[2, 2], [4, 4], [2, 6]], w: [], flip: [[4, 2], [4, 6]] },
    // L8 回折隐蔽联动（首镜可见 + 两面下游镜单修无反馈）
    { e: [[0, 0, '>']], m: [[0, 7, '\\'], [4, 7, '/'], [4, 2, '\\']], k: [[0, 4], [2, 7], [4, 5], [1, 2]], w: [], flip: [[0, 7], [4, 7], [4, 2]] },
    // L9 恒等中间态（下游镜单修恒等，需配合首镜）
    { e: [[8, 8, '<']], m: [[8, 5, '\\'], [5, 5, '/']], k: [[8, 7], [6, 5], [5, 7]], w: [], flip: [[8, 5], [5, 5]] },
    // L10 顶折回环（首镜可见 + 两面无感）
    { e: [[0, 0, 'v']], m: [[3, 0, '\\'], [3, 7, '/'], [0, 7, '\\']], k: [[2, 0], [3, 4], [1, 7], [0, 5]], w: [], flip: [[3, 0], [3, 7], [0, 7]] },
    // L11 就位镜教学（翻坏全灭）+ 双无感（初盘一面就位）
    { e: [[0, 0, '>']], m: [[0, 6, '\\'], [4, 6, '/'], [4, 2, '\\'], [1, 2, '/']], k: [[2, 6], [4, 4], [3, 2], [1, 5]], w: [], flip: [[4, 6], [4, 2], [1, 2]] },
    // L12 初盘撞墙 + 无感链（仅首镜可见）
    { e: [[4, 8, '<']], m: [[4, 6, '\\'], [1, 6, '\\'], [1, 3, '/']], k: [[4, 7], [2, 6], [1, 4], [5, 3]], w: [[6, 6]], flip: [[4, 6], [1, 6], [1, 3]] },
    // L13 四镜之字长廊
    ...
    // L15 双束共享水晶（十字交点；修复旧版 5 解 + 1 步捷径）
    { e: [[0, 2, 'v'], [8, 6, '^']], m: [[7, 2, '\\'], [6, 6, '\\'], [6, 3, '\\']], k: [[7, 6], [6, 2], [7, 4], [4, 3]], w: [], flip: [[7, 2], [6, 6], [6, 3]] },
    // L16 四镜围墙绕行
    ...
    // L21 挑战：双束回折会师（par 5，链式断链——每面镜都是下一面的前置）
    { e: [[0, 0, '>'], [8, 8, '^']], m: [[0, 4, '\\'], [4, 4, '/'], [4, 1, '\\'], [1, 1, '/'], [5, 8, '\\']], k: [[1, 4], [1, 6], [4, 2], [5, 6], [5, 3], [7, 8]], w: [], flip: [[0, 4], [4, 4], [4, 1], [1, 1], [5, 8]] },
    // L22 挑战：双束分进合击（par 5，两束各自独立链路，合流点亮末段）
    { e: [[4, 0, '>'], [0, 8, 'v']], m: [[4, 6, '\\'], [7, 6, '\\'], [2, 8, '/'], [2, 1, '\\'], [1, 1, '/']], k: [[2, 6], [2, 4], [1, 3], [4, 2], [5, 6], [7, 7]], w: [], flip: [[4, 6], [7, 6], [2, 8], [2, 1], [1, 1]] },
    // L23 挑战：六镜蛇形长廊（par 6，单束六连折，递进点亮）
    { e: [[0, 0, '>']], m: [[0, 7, '\\'], [4, 7, '/'], [4, 3, '\\'], [1, 3, '/'], [1, 6, '\\'], [6, 6, '/']], k: [[2, 7], [4, 5], [2, 3], [1, 4], [3, 6], [6, 3]], w: [[5, 3]], flip: [[0, 7], [4, 7], [4, 3], [1, 3], [1, 6], [6, 6]] },
    // L24 挑战：双束镜阵（par 5，墙斩断错误分支）
    { e: [[8, 0, '^'], [0, 8, 'v']], m: [[5, 0, '/'], [5, 4, '/'], [3, 4, '\\'], [3, 1, '/'], [1, 8, '/']], k: [[5, 3], [4, 4], [3, 3], [7, 1], [1, 7], [1, 5]], w: [[1, 4], [8, 4]], flip: [[5, 0], [5, 4], [3, 4], [3, 1], [1, 8]] },
    // L25 挑战：收官双束六镜（par 5，就位镜 + 链式合流）
    { e: [[0, 4, 'v'], [8, 2, '^']], m: [[3, 4, '\\'], [3, 7, '/'], [1, 7, '\\'], [6, 2, '/'], [6, 5, '/'], [4, 5, '\\']], k: [[1, 6], [1, 5], [2, 7], [6, 3], [5, 5], [4, 4]], w: [[3, 1], [5, 7]], flip: [[3, 4], [3, 7], [1, 7], [6, 2], [6, 5]] },
];
